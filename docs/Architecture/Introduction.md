...
|2       |Maintainability       |The system can be modified, corrected, adapted or improved.                                   |AMIRIS can be easily adapted, fixed, and expanded. New agents, markets, components, and policy mechanisms can be implemented easily.                               |
...
|4       |Performance Efficiency|The system provides appropriate performance relative to the amount of resources used.         |Simulations with AMIRIS can be executed fast even on small desktop computers with one computation core.                                                            |
|5       |Transferability       |System can be transferred from one environment to another.                                    |AMIRIS can be easily coupled and combined with other agent-based simulations.                                                                                      |

## Stakeholders

|Role / Name                                                                                                                |Expectations                                                             |
|---------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------|
|Team Energy Economics, Department of Energy Systems Analysis, Institute of Networked Energy System, German Aerospace Center|Team members shall be enabled to guide the development of AMIRIS.        |
