...
```mermaid
%%{init: { "theme": "default", "timeline": { "disableMulticolor": true} }}%%
timeline
  ...
  2022: The AMIRIS release workshop is held.
  2023: AMIRIS Examples v1.0 are published.
      : AMIRIS is peer-reviewed and published at JOSS.
  2024: AMIRIS v2.0 is published.
      : AMIRIS v3.0 is published.
  2025: 30 external user of AMIRIS are confirmed.
      : AMIRIS and its accompanying tools account for a total of 50 releases.
      : AMIRIS v4.0 is published.
